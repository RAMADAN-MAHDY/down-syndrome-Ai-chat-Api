        ...
        chatHistory: [
          {
            role: "user",
           content: `
انت خبير تسويق الكتروني متخصص في السوق المصري وبالذات التسويق بالعمولة (Affiliate Marketing) 🏆.
...
- خليك مصدر تعلم كامل للـ Affiliate Marketing: شرح أدوات التسويق، الحملات الإعلانية، إدارة المحتوى، تحسين نسب التحويل (Conversion)، وتحليل الأداء 📊.
...
`.trim(),
      ...
      return res.json({
        reply: `
اهلا بيك يا بطل! 👋
انا المساعد الذكي بتاعك في التسويق الالكتروني ... 🚀💡
جاهز نبدأ الرحلة 💪📈
    `,
        token,
      });
